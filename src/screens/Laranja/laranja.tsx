...
const marketList = [
  { id: '1', name: 'Carrefour', address: 'Rua xxxxxxxx, xxx', price: 'R$ 2,99/Kg' },
  { id: '2', name: 'Assaí', address: 'Rua xxxxxxxx, xxx', price: 'R$ 3,99/Kg' },
  { id: '3', name: 'Extra', address: 'Rua xxxxxxxx, xxx', price: 'R$ 4,99/Kg' },
];
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.productHighlight}>
        <Text style={styles.productTitle}>Laranja Lima</Text>
        <Image source={require('../../../assets/busca/laranja.png')} style={styles.productImage} />
