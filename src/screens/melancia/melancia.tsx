...
const marketList = [
  ...
  { id: '2', name: 'Assaí', address: 'Rua xxxxxxxx, xxx', price: 'R$ 3,49/Kg' },
  { id: '3', name: 'Extra', address: 'Rua xxxxxxxx, xxx', price: 'R$ 3,29/Kg' },
];
   ...
   return (
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.productHighlight}>
          <Text style={styles.productTitle}>Melancia</Text>
          <Image source={require('../../../assets/busca/melancia.png')} style={styles.productImage} />
