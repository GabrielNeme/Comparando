...
const marketList = [
  { id: '1', name: 'Carrefour', address: 'Rua xxxxxxxx, xxx', price: 'R$ 1,99/Unidade' },
  { id: '2', name: 'Assaí', address: 'Rua xxxxxxxx, xxx', price: 'R$ 2,49/Unidade' },
  { id: '3', name: 'Extra', address: 'Rua xxxxxxxx, xxx', price: 'R$ 2,99/Unidade' },
];
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.productHighlight}>
        ...
        <TouchableOpacity onPress={() => setIsFavorite(!isFavorite)} style={styles.favoriteIcon}>
          <FontAwesome name={isFavorite ? 'heart' : 'heart-o'} size={24} color={isFavorite ? 'green' : 'gray'} />
        </TouchableOpacity>
      </View>
